...
public class QKART_Tests {
    ...
    public static void createDriver() throws MalformedURLException, IOException {
        ...
        // create new excel file (replace if exists)
        Writer fileWriter = new FileWriter("/home/crio-user/workspace/akashsdesai15-ME_QKART_QA/app/RunResults.xlsx");
        fileWriter.close();
    }

...
public class Checkout {
    ...
    public Boolean selectAddress(String addressToSelect) {
        try {
            ...
            List<WebElement> allBoxes = driver.findElements(By.xpath("//p[text()='"+addressToSelect+"']//ancestor::div[2]"));
    ...
    public Boolean placeOrder() {
        try {
            ...
            List<WebElement> elements = driver.findElements(By.xpath("//button[contains(@class,'css-177pwqq') and text()='PLACE ORDER']"));

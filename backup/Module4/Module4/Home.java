...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            Thread.sleep(3000);
            Boolean status = wait.until(ExpectedConditions.or(
            ...
            // ExpectedConditions.presenceOfElementLocated(By.xpath("//div[contains(@class, 'loading')]//h4[text()=' No products found ']"))));
            // Thread.sleep(3000);
            // return true;
            return status;
        } catch (Exception e) {
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            List<WebElement> cartContents = driver.findElements(By.xpath("//div[contains(@class, 'css-1gjj37g')]/div[1]"));

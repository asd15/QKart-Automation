...
public class Checkout {
    ...
    public Boolean addNewAddress(String addresString) {
        try {
            ...
            addBtn.click();
            wait.until(ExpectedConditions.and(ExpectedConditions.invisibilityOf(addBtn), ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[text()='"+addresString+"']"))));
            return true;
        } catch (Exception e) {
    ...
    public Boolean placeOrder() {
        try {
            ...
            return this.driver.getCurrentUrl().endsWith("/thanks");
        } catch (Exception e) {
